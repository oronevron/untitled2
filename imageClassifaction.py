...
# layers
h_conv1 = tf.nn.relu6(globalFunctions.conv2d(x_tensor, W_conv1) + b_conv1)
h_pool1 = globalFunctions.max_pool_2x2(h_conv1)

h_conv2 = tf.nn.relu6(globalFunctions.conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = globalFunctions.max_pool_2x2(h_conv2)

h_conv3 = tf.nn.relu6(globalFunctions.conv2d(h_pool2, W_conv3) + b_conv3)
...
saver.restore(sess, "FinalDataset/Model/Model3/Model")
